...
const containerVariants = cva(
  "fixed shadow-xl border overflow-hidden bg-background text-foreground flex flex-col border-border",
  {
    variants: {
...
const headerVariants = cva("py-1 bg-secondary border-border", {
  variants: {
...
const resizeHandleClasses: Record<ResizeDirection, string> = {
  ...
  se: "absolute bottom-0 right-0 w-3 h-3 cursor-se-resize hover:bg-muted rounded-tl-sm transition-colors",
