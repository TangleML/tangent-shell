 ...
 *
 * Ported from the sister project (TangleML/tangle-ui).
 * See src/shared/ui/DESIGN_SYSTEM.md.
 *
...
const rule = {
  meta: {
    ...
    messages: {
      noClassname:
        '<{{component}}> does not accept `className`. Use semantic props instead. See "src/shared/ui/DESIGN_SYSTEM.md".',
      softBanned:
