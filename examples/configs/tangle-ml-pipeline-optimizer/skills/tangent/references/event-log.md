...
**run_submit**
```json
{"type": "run_submit", "ts": "2025-01-15T10:33:00Z", "round": 1, "run_id": "abc123", "experiment_type": "parameter_tuning", "label": "<short-description>", "config_changes": {"learning_rate": 0.05}, "annotations": {"tangent": "true", "session": "2025-01-15-<scenario_name>", "round": "1"}, "pipeline_args": {}}
```
...
for learning).
```json
{"type": "learning_upload_failed", "ts": "2025-01-15T12:05:00Z", "round": 1, "artifact": "learning", "key_run_id": "abc123", "local_path": "logs/learning-abc123.json", "gcs_uri": "gs://shopify-discovery-relevance/tangent/learnings/<scenario>/learning-abc123.json", "error_summary": "PERMISSION_DENIED: caller does not have storage.objects.create"}
```
